        ...
        <TooltipTrigger asChild>
          <Link
            className={cn(
              ...
              "text-muted-foreground/80 hover:text-foreground transition-none hover:bg-transparent disabled:opacity-100  lg:group-focus-within/item:opacity-100 lg:group-hover/item:opacity-100"
            )}
